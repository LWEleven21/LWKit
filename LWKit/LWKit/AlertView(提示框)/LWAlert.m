...
#import "LWAlert.h"
@interface LWAlert() <UITextFieldDelegate>
...
- (void)needsDisplay{
    ...
    if (argsArray.count <= 2) {
        ...
        for (int j = 0; j < [argsArray count]; j++){
            ...
            [button setTitleColor:[UIColor colorWithRed:(20.0/255) green:(100.0/255) blue:(251.0/255) alpha:1] forState:UIControlStateNormal];
